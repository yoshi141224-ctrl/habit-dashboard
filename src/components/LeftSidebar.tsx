  ...
  return (
    <aside className="ls-root">
      <div className="ls-nav-rail">
        {[
          { id: 'home', d: 'M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z M9 22V12h6v10' },
          { id: 'calendar', d: 'M8 2v4 M16 2v4 M3 10h18 M5 4h14a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2z' },
          { id: 'habits', d: 'M9 11l3 3L22 4 M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11' },
          { id: 'stats', d: 'M18 20V10 M12 20V4 M6 20v-6' },
        ].map(({ id, d }) => (
          <button key={id} className={`ls-nav-icon${activeNav === id ? ' active' : ''}`} onClick={() => onNavChange(id)}>
        ...
        {/* Mobile View */}
        <button
          className={`ls-nav-icon${activeNav === 'mobile' ? ' active' : ''}`}
          onClick={() => onNavChange('mobile')}
          title="Mobile View"
        >
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
